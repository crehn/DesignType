...
function fillPageWithContent(cardname) {
	...
	//putCommentElementIntoPage(designCardObj.commentId);
...
function putCommentElementIntoPage(commentId) {
	var commentElement = "<dt-comments-subfolder pageid='" + commentId + "'></dt-comments-subfolder>";
	$('.commentmarginhorizontal').append(commentElement);
}
