var carddetailtemplate = /*html*/`
			<div class="col">
				<label for="acronym">Design Card Acronym:</label>
				<br />
				<span id="acronym" class="c_acronym"></span>
				<br />
				<label for="cardname">Design Card Name:</label>
				<br />
				<span id="cardname" class="c_cardname"></span>
				<br />
				<label for="dimension">Design Card Dimension:</label>
				<br />
				<img id="dimensionpicture" src="AUTOFILLED" height="50" /> : <a id="dimensionlink" href="AUTOFILLED"><span id="dimension" class="c_dimension"></span></a>
				<br />
				<label for="level">Design Card Level:</label>
				<br />
				<img id="levelpicture" src="AUTOFILLED" height="50" /> : <span id="level" class="c_level"></span>
				<br />
			</div>
			<div class="col">
				<img id="cardpicture" class="cardpicmargintop" src="todo" />
			</div>
			<div class="col">
				<label for="shortdesc">Short description:</label>
				<br />
				<span id="shortdesc" class="c_shortdesc"></span>
				<br />
				<label for="longdesc">Long description:</label>
				<br />
				<span id="longdesc" class="c_longdesc"></span>
			</div>
			<dt-sidebar class="col-md-2"></dt-sidebar>

			<div class="w-100">
				<div class="col">
					<a href="../cards.html" >&lt;&lt; all cards</a>
				</div>
			</div>

			<div class="w-100" id="referencedargs">
				<div class="col">
					<h2>Related Arguments</h2>
					<div class="references table-responsive"></div>
				</div>
			</div>

			<div class="w-100 fromprinciples">
				<div class="col">
					<div class="rationale"></div>
					<span class="principleswikitext">Learn more at <a href="AUTOFILLED" class="principleswikilink">principles-wiki</a></span>
				</div>
			</div>
...
var cardsData = {
    ...
    YAGNI: {
        ...
        set: 'advanced',
        setIcon: '../img/cardset/icons/advanced_simple.png',
    ...
    RoP: {
        ...
        set: 'basic',
        setIcon: '../img/cardset/icons/basic_powerful.png',
    ...
    FP: {
        ...
        set: 'advanced',
        setIcon: '../img/cardset/icons/advanced_powerful.png',
    ...
    LC: {
        ...
        set: 'basic',
        setIcon: '../img/cardset/icons/basic_abstract.png',
    ...
    SRP: {
        ...
        set: 'advanced',
        setIcon: '../img/cardset/icons/advanced_abstract.png',
        principlesWikiUrl: "http://principles-wiki.net/principles:low_coupling",
        commentId: "c_srp",
        links: [
            refLink('↑', 'PSU', 'Principle of Separate Understandability', 'advanced', 'ToDo'),
    ...
    DRY: {
        ...
        set: 'basic',
        setIcon: '../img/cardset/icons/basic_concrete.png',
    ...
    IH_E: {
        ...
        set: 'advanced',
        setIcon: '../img/cardset/icons/advanced_concrete.png',
    ...
    CF: {
        ...
        set: 'basic',
        setIcon: '../img/cardset/icons/basic_pragmatic.png',
        principlesWikiUrl: "none",
        commentId: "c_cf",
        links: [
    ...
    ICC: {
        ...
        set: 'advanced',
        setIcon: '../img/cardset/icons/advanced_pragmatic.png',
        principlesWikiUrl: "none",
        commentId: "c_icc",
        links: [
            refLink('↑', 'CF', 'Customer Focus', 'basic', 'ToDo'),
    ...
    PoQ: {
        ...
        set: 'basic',
        setIcon: '../img/cardset/icons/basic_idealistic.png',
        principlesWikiUrl: "none",
        commentId: "c_poq",
        links: [
            refLink('↑', 'LC', 'Low Coupling', 'basic', 'ToDo'),
    ...
    UP: {
        ...
        set: 'advanced',
        setIcon: '../img/cardset/icons/advanced_idealistic.png',
    ...
    ML: {
        ...
        set: 'basic',
        setIcon: '../img/cardset/icons/basic_robust.png',
        principlesWikiUrl: "http://principles-wiki.net/principles:model_principle",
        commentId: "c_ml",
        links: [
    ...
    IR: {
        ...
        set: 'advanced',
        setIcon: '../img/cardset/icons/advanced_robust.png',
        principlesWikiUrl: "none",
        commentId: "c_ir",
        links: [
            refLink('↑', 'RoS', 'Rule of Standardization', 'advanced', 'ToDo'),
    ...
    TP: {
        ...
        set: 'basic',
        setIcon: '../img/cardset/icons/basic_technologic.png',
        principlesWikiUrl: "none",
        commentId: "c_XXX",
        links: [
            refLink('↑', 'FRD', 'Frequency Reduces Difficulty', 'advanced', 'ToDo'),
    ...
    FRD: {
        ...
        set: 'advanced',
        setIcon: '../img/cardset/icons/advanced_technologic.png',
        principlesWikiUrl: "none",
        commentId: "c_frd",
        links: [
            refLink('↑', 'ML', 'Murphy’s Law', 'basic', 'ToDo'),
    ...
    qFoc: {
        ...
        set: 'basic',
        setIcon: '../img/cardset/icons/basic_question.png',
        principlesWikiUrl: "none",
        commentId: "c_qfoc",
        links: "",
    },
    ...
    qTRT: {
        ...
        set: 'advanced',
        setIcon: '../img/cardset/icons/advanced_question.png',
        principlesWikiUrl: "none",
        commentId: "c_qtrt",
        links: "",
    },
    ...
    aMed: {
        ...
        set: 'basic',
        setIcon: '../img/cardset/icons/basic_action.png',
        principlesWikiUrl: "none",
        commentId: "c_amed",
        links: "",
    },
    ...
    aDaC: {
        ...
        set: 'advanced',
        setIcon: '../img/cardset/icons/advanced_action.png',
        principlesWikiUrl: "none",
        commentId: "c_adac",
        links: "",
    },
