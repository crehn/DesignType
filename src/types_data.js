...
sait: {
    ...
    suggestions: ["Try not to lose focus on business needs. Often elegance is not expected but expensive in effort and time.",
...
scpr: {
    ...
    suggestions: ["Try not to lose the big picture while focusing on problems step by step. Otherwise your design will break very quickly.",
...
pait: {
    name: 'The Scientist',
    description: "The Scientist can find a solution for even the hardest problems. It may take a while but a well-thought-out solution will be there, eventually. Not everybody understands The Scientist's code but one can be sure: it's a masterpiece. He is aware of all the new technologic achievements and examines them to get a better understanding and also to use them for his purposes. He is excited by the academical challenge of a task which can be more interesting than the particular customers' needs and he won't surrender until it is solved.",
    ...
    principlesDisregarded: [principle('KISS', 'keep_it_simple_stupid'),
        principle('RoE', 'rule_of_explicitness'),
        principle('PSU', 'principle_of_separate_understandability')],
    strengths: ["Given enough time The Scientist can solve almost any problem.",
...
pair: {
    ...
    suggestions: ["Your colleagues may like to start coding earlier than you. This is not necessarily a shortcoming. It's just another way of building software with its own advantages and disadvantages. Find a way to cooperate with them although they think differently.",
        ...
        "Don't lose focus on the details and get your hands dirty from time to time to keep you familiar with the current state of coding."],
    furtherReading: [],
},
pcpt: {
    name: 'The Chef',
    ...
    suggestions: ["Be careful with playing around. It can consume time when you lose focus on the real goal.",
...
pcpr: {
    ...
    suggestions: ["Sorcerers tend to lose the view for the big picture. Step back once in a while and look if something can be improved. Maybe you will realize that something is unnecessary. You may then remove it and exchange it for something more helpful.",
